...
interface IAgingVehicleOtdProps {
}
interface IAgingVehicleOtdState {
...
class AgingVehicleOtd extends React.Component<IAgingVehicleOtdProps, IAgingVehicleOtdState> {
    state: IAgingVehicleOtdState = {
    ...
    setFixedHeight = () => {
        ...
        if (fold) {
            wzsCommonFlod.style.height = `${82}px`
        } else {
    ...
    render() {
        ...
        return <div className={styles.AgingVehicleOtd}>
            {/* 下拉刷新 */}
            <PullToRefresh
...
export default AgingVehicleOtd